...
- Para instalar o Node.js você precisará acessar a página `https://nodejs.org` e logo na home page serão exibidas as duas principais versões para download         optando sempre para a versão LTS.
